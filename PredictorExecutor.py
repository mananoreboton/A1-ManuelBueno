...
class PredictorExecutor:
    def cross_validation(self, hyperparameters, X_in, y_in, scoring='neg_mean_absolute_error', folds=10):
        ...
        for i, params in hyperparameters.iterrows():
            ...
            scores = cross_val_score(neural_net_predictor, X_in, y_in, cv=folds, scoring=scoring)
...
if __name__ == "__main__":
    ...
    hyperparameters_and_score_by_index = predictor_executor.cross_validation(hyperparameters, X_in, y_in, folds=10)
